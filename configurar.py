...
def config_main():
    ...
    layout = [
        ...
        [sg.Text('Sustantivos:', justification='center'), sg.InputCombo(list(range(len(list(d['sustantivo'].keys()))+1)), key= 'cantsus', size=(5,5), readonly=True, default_value=int(config['Cantidad_Sustantivos'])),sg.Button(key ='colorSus',button_text='color',button_type=sg.BUTTON_TYPE_COLOR_CHOOSER)],
